...
class dashboard extends Component {
  ...
  changeSearchTerm() {
    this.state.searchTerm === "menu"
      ? this.setState({ searchTerm: "restaurant" })
      : this.setState({ searchTerm: "menu" });
  }
    ...
    return (
      <div>
        ...
        <div className="search-change-section">
          Search By :{" "}
          <button onClick={() => this.changeSearchTerm()}>
            {this.state.searchTerm} Title
          </button>
        </div>
